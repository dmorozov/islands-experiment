 ...
 * T358-T359: Contains optional name and colorCode fields.
 * Uses PATCH semantics - only non-null fields will be updated.
 *
 * @param name the category name (optional, 1-50 characters if provided, unique per user)
 * @param colorCode the hex color code (optional, 7 characters including # if provided, e.g., #FF5733)
 */
